...
public class MymensorAuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mymensorauthenticator);
    ...
    private class GetTokens extends AsyncTask<String, Integer, IdTokenResponse> {
        ...
        protected void onPostExecute(IdTokenResponse result) {
            try {
                ...
                Log.d("Info:",idToken.toString());
                String userName = idToken.getPayload().get("email").toString();

                Account account = new Account(userName, MymensorAccAuthenticator.ACCOUNT_TYPE);
                ...
                data.putString(AccountManager.KEY_ACCOUNT_TYPE, MymensorAccAuthenticator.ACCOUNT_TYPE);
